...
class CommsStage(AgenticStage):
    ...
    def __init__(
        ...
        self.concierge_profile: LLMProfile | None = (
            execution_context.try_llm_profile("comms.concierge") if execution_context else None
        )
        self.critic_profile: LLMProfile | None = (
            execution_context.try_llm_profile("comms.critic", fallback="comms.concierge") if execution_context else None
        )
