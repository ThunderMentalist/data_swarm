...
class NavigationStage(AgenticStage):
    ...
    def __init__(
        ...
        self.concierge_profile: LLMProfile | None = (
            execution_context.try_llm_profile("navigation.concierge") if execution_context else None
        )
        self.critic_profile: LLMProfile | None = (
            execution_context.try_llm_profile("navigation.critic", fallback="navigation.concierge") if execution_context else None
        )
