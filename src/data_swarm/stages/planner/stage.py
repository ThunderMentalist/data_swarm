...
class PlannerStage(AgenticStage):
    ...
    def __init__(
        ...
        self.concierge_profile: LLMProfile | None = (
            execution_context.try_llm_profile("planner.concierge") if execution_context else None
        )
        self.critic_profile: LLMProfile | None = (
            execution_context.try_llm_profile("planner.critic", fallback="planner.concierge") if execution_context else None
        )
